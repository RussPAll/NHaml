...
namespace NHaml.Tests.Walkers.CodeDom
{
    ...
    public class HamlNodeTagWalker_Tests
    {
        ...
        {
            // Arrange
            var tagNode = new HamlNodeTag(new HamlLine(templateLine, HamlRuleEnum.Tag, indent: ""));
        ...
        public void Walk_SelfClosingTag_AppendsCorrectTag()
        {
            ...
            var tagNode = new HamlNodeTag(new HamlLine(tagName, HamlRuleEnum.Tag, indent: ""));
        ...
        public void Walk_IndentedTag_AppendsIndent()
        {
            // Arrange
            const string indent = "  ";
            var tagNode = new HamlNodeTag(new HamlLine("p", HamlRuleEnum.Tag, indent: indent));
        ...
        public void Walk_NestedTags_AppendsCorrectTags()
        {
            ...
            var tagNode = new HamlNodeTag(new HamlLine(tagName, HamlRuleEnum.Tag, indent: ""));
            tagNode.AddChild(new HamlNodeTextContainer(new HamlLine(nestedText, HamlRuleEnum.PlainText, indent: "", isInline: true)));
            // Act
            _tagWalker.Walk(tagNode);
        ...
        {
            var tagNode = new HamlNodeTag(new HamlLine(line1, HamlRuleEnum.Tag, indent: ""));
            tagNode.AddChild(new HamlNodeTag(new HamlLine(line2, HamlRuleEnum.Tag, indent: "  ")));
        ...
        public void Walk_InternalWhitespaceRemoval_GeneratesCorrectOutput()
        {
            ...
            tagNode.AddChild(new HamlNodeTextContainer(new HamlLine("\n", HamlRuleEnum.PlainText, indent: "")));
            tagNode.AddChild(new HamlNodeTextContainer(new HamlLine("  Hello", HamlRuleEnum.PlainText, indent: "")));
        ...
        public void Walk_InlineContent_GeneratesCorrectOutput()
        {
            ...
            tagNode.AddChild(new HamlNodeTextContainer(new HamlLine("Content", HamlRuleEnum.PlainText, indent: "\t", isInline: true)));
