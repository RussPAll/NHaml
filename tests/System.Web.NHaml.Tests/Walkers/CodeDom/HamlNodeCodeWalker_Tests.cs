...
namespace NHaml.Tests.Walkers.CodeDom
{
    ...
    public class HamlNodeCodeWalker_Tests
    {
        ...
        public void Walk_ValidNodeWithNoChildren_CallsAppendCodeSnippetMethodWithFalse()
        {
            ...
            var node = new HamlNodeCode(new HamlLine(codeSnippet, HamlRuleEnum.Code, indent: "", sourceFileLineNum: -1));
        ...
        {
            var node = new HamlNodeCode(new HamlLine("1+1", HamlRuleEnum.Code, indent: "", sourceFileLineNum: -1));
        ...
        public void Walk_ConditionalWithChildNode_RendersChildNode()
        {
            ...
            var node = new HamlNodeCode(new HamlLine("if (true)", HamlRuleEnum.Code, indent: "", sourceFileLineNum: -1));
            node.AddChild(new HamlNodeTextContainer(0, 0, dummyText));
        ...
        {
            var node = new HamlNodeCode(new HamlLine("1+1", HamlRuleEnum.Code, indent: "", sourceFileLineNum: -1));
            var childNode = new HamlNodeCode(new HamlLine("1+1", HamlRuleEnum.Code, indent: "", sourceFileLineNum: -1));
