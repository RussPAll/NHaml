...
namespace NHaml.Tests.Parser.Rules
{
    ...
    public class HamlNodeTag_Tests
    {
        ...
        {
            var tag = new HamlNodeTag(new HamlLine(templateLine, HamlRuleEnum.Tag, indent: "", sourceFileLineNum: 0));
        ...
        {
            const string templateLine = "p(a='b'";
            var line = new HamlLine(templateLine, HamlRuleEnum.Tag, indent: "", sourceFileLineNum: 0);
